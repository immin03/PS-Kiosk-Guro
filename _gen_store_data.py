...
ZONES_MAP = [
    ...
    {"id": "B", "label": "브랜드 · 간식 · 음료", "color": "#7C6FD0", "desc": "B1~B10", "catType": "health"},
    {"id": "C", "label": "뷰티 라이프스타일", "color": "#E07A93", "desc": "C1~C25", "catType": "beauty"},
    {"id": "D", "label": "브랜드존", "color": "#3E7CC4", "desc": "D1~D15", "catType": "beauty"},
